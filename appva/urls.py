...
urlpatterns = [
    ...
    path('RELATORIO_VALOR_ADICIONADO_ANALITICO/<str:municipio>/<str:remessa>/<str:portaria>/<str:inscricao>/<str:tabela>/<str:cadastro>/<str:ano>/', views.RELATORIO_VALOR_ADICIONADO_SINTETICO, name='RELATORIO_VALOR_ADICIONADO_SINTETICO'),
]
