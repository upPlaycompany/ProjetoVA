...
urlpatterns = [
    ...
    path('RELATORIO_VALOR_ADICIONADO_SINTETICO/<str:portaria>/<str:inscricao>/', views.RELATORIO_VALOR_ADICIONADO_SINTETICO, name='RELATORIO_VALOR_ADICIONADO_SINTETICO'),
]
