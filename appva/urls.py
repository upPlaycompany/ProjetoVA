...
urlpatterns = [
    ...
    path('RELATORIO_VALOR_ADICIONADO_SINTETICO/<str:portaria>/<str:inscricao>/<str:tabela>/<str:cadastro>/', views.RELATORIO_VALOR_ADICIONADO_SINTETICO, name='RELATORIO_VALOR_ADICIONADO_SINTETICO'),
]
